...
import { Plus, Trash2, GitBranch, Bot, Zap, Download, Package, ChevronRight, ChevronDown } from "lucide-react";
          ...
          <div className="space-y-2">
            {installedPlugins.map((plugin) => {
              ...
              return (
                <div key={plugin.id}>
                  <Card
                    className="flex items-center justify-between px-4 py-3 cursor-pointer hover:border-line-strong transition-colors"
